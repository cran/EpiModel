...
##
##  These internal functions are used for testing EpiModel simulations 
##  outside of the standard R CMD check testing process, since simulation
##  runs take long to run. The main testing functions below check  
##  for consistency of output: that the compartment sizes and flows
##  are consistent according to discrete-time difference equations
##
########################################################################
